...
- A draft with a body and an empty title cannot be committed, so it stays open with the warning "New item needs a title", and focus that would land on the list goes back to its title. A draft with neither title nor body is dropped.
